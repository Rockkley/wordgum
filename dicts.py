def return_dict(dict_data):
    if dict_data == 'animals_eng':
        ...
        return {'Porkkana': 'Морковь', 'Leipä': 'Хлеб', 'Omena': 'Яблоко', 'Appelsiini': 'Апельсин', 'Juusto': 'Сыр',
                'Keksit': 'Печенька', 'Salaatti': 'Салат', 'Voileipä': 'Сэндвич', 'Keitto': 'Суп', 'Öljy': 'Масло',
                'Sipuli': 'Лук', 'Valkosipuli': 'Чеснок', 'Paahtoleipä': 'Гренки', 'Kurpitsa': 'Тыква',
                'Maissi': 'Кукуруза', 'Piirakka': 'Пирог', 'Kakku': 'Торт', 'Raejuusto': 'Творог', 'Kerma': 'Сливки'}
